...
import styles from "./profesor/profesor.module.css"
...
export default function Prijava() {
    ...
    useEffect(() => {
        //@ts-ignore
        if(session && session.user.uloga === "Profesor") {
            router.push("/predmeti/predmetiForProfesor");
        }
    }, [session]);
    const login = async () => {
        ...
        if(result.ok) {
            await router.push("/predmeti/predmetiForProfesor");
        } else {
